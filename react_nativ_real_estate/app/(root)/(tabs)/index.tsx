        ...
        ListHeaderComponent={
          ...
          <View className="my-5">
            ...
            <FlatList 
              ...
              renderItem={({item}) => <FeaturedCard item={item} onPress={() => handleCardPress(item.$id)} />} keyExtractor={(item) => item.toString()} horizontal 
              bounces={false}
          ...
          <View className="flex flex-row items-center justify-between">
              <Text className="textj-xl font-rubik-bold text-black-300" >Our Recommendation</Text>
              <TouchableOpacity>
                <Text className="text-base font-rubik-bold text-primary-300" >See All</Text>
              </TouchableOpacity>
            </View>
